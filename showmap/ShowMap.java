...
public void moveEast () {
	...
	viewMapX = viewMapX + viewWidth/100*1;
	checkViewPoint ();
...
public void moveNorth () {
	...
	viewMapY = viewMapY - viewHeight/100*1;
	checkViewPoint ();
...
public void zoomIn () {
	...
	//viewMapY = viewMapY * 2;
	scale = scale-10;
	viewMapX = viewMapX +10;
	viewMapY = viewMapY +10;
	checkViewPoint ();
	repaint ();
	loadDrawables();
}
