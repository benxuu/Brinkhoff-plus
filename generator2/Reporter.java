...
public void reportDisappearingObjectAndEdge (double time, long id, int repNum, int objClass,long lastNode,double relDist,Edge cEdge, int x, int y, double doneDist, int reportProbability) {
}
//reporter.reportDisappearingObjectAndEdge(arrivalTime,id,repNum,objClass,relDist,route.getEdge(),dest.getX(),dest.getY(),0.0,doneDist,objClasses.getReportProbability(objClass));
